...
(let ((dst-dir (uiop:merge-pathnames* (format nil "./shake-~A-~A/"
  ...
  (uiop:run-program '("sbcl" "--eval" "(asdf:make :shake/executable)" "--quit"))
  (uiop:rename-file-overwriting-target
   "shake/shake-command.exe"
   (uiop:merge-pathnames* "shake.exe" dst-dir))
  (format t "Created: ~A~%" (uiop:merge-pathnames* "shake.exe" dst-dir))
